            ...
            <form id="form" action="{{url('add_project')}}" method="POST" enctype="multipart/form-data">
                ...
                <fieldset>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="project-description" rows="5" placeholder="Enter project description" required></textarea>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="github_link" id="github-link" placeholder="Enter GitHub Link" required />
                    </div>
                    <div>
                        <label for="live-preview-link">Live Preview Link</label>
                        <input type="text" name="live_preview_link" id="live-preview-link" placeholder="Enter live preview link" required />
                    </div>
